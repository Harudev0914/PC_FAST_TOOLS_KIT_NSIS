      ...
      <div className="error-container">
        <div className="error-icon">
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M40 40L80 80M80 40L40 80" stroke="#FF003F" strokeWidth="6" strokeLinecap="round"/>
            <text x="60" y="95" textAnchor="middle" fill="#FF003F" fontSize="24" fontWeight="bold">404</text>
          </svg>
        </div>
        ...
        <div className="error-actions">
          ...
          <button className="error-button secondary" onClick={() => window.history.back()}>
            이전 페이지
          </button>
        </div>
